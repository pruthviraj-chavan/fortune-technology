...
const UK = () => {
  const country = countryData.find(c => c.slug === 'uk');
  ...
  return (
    <div className="min-h-screen">
      <SEOHead 
        title={`Work in the UK from Kolhapur | Fortune Technology`}
        description={`Discover high-paying job opportunities in the UK for Kolhapur residents. Fortune Technology helps with job placement, visa assistance, and language preparation.`}
        keywords={`jobs in UK, work in UK, UK jobs for Indians, jobs abroad from Kolhapur, UK work visa, ${country.industries.join(', ')}, job opportunities in UK, Kolhapur employment agency`}
        canonicalUrl={`/jobs/work-in-uk`}
      />
      ...
      <section className={`bg-gradient-to-r ${country.gradientClass} text-white py-16`}>
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-6">Work in the UK from Kolhapur</h1>
