...
const Spain = () => {
  const country = countryData.find(c => c.slug === 'spain');
  ...
  return (
    <div className="min-h-screen">
      <SEOHead 
        title={`Work in Spain from Kolhapur | Fortune Technology`}
        description={`Discover high-paying job opportunities in Spain for Kolhapur residents. Fortune Technology helps with job placement, visa assistance, and language preparation.`}
        keywords={`jobs in Spain, work in Spain, Spain jobs for Indians, jobs abroad from Kolhapur, Spain work visa, ${country.industries.join(', ')}, job opportunities in Spain, Kolhapur employment agency`}
        canonicalUrl={`/jobs/work-in-spain`}
      />
      ...
      <section className={`bg-gradient-to-r ${country.gradientClass} text-white py-16`}>
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-6">Work in Spain from Kolhapur</h1>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-12">
              ...
              <div>
                <h2 className="text-3xl font-bold gradient-text mb-6">Why Choose Spain for Jobs?</h2>
              ...
              {/* Popular Job Sectors */}
              <div>
                <h2 className="text-3xl font-bold gradient-text mb-6">Popular Job Sectors in Spain</h2>
              ...
              <div>
                <h2 className="text-3xl font-bold gradient-text mb-6">Eligibility & Requirements to Work in Spain</h2>
              ...
              <div>
                <h2 className="text-3xl font-bold gradient-text mb-6">Job Search Platforms & Agencies in Spain</h2>
                <div className="bg-white p-6 rounded-lg shadow-md">
                  <div className="space-y-4">
              ...
              {/* Salary Expectations */}
              <div>
                <h2 className="text-3xl font-bold gradient-text mb-6">Salary Expectations for Indians in Spain</h2>
                <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              {/* Life as an Indian */}
              <div>
                <h2 className="text-3xl font-bold gradient-text mb-6">Life as an Indian in Spain</h2>
                <div className="bg-white p-6 rounded-lg shadow-md">
                  <div className="space-y-6">
              ...
              <div className="bg-gradient-to-b from-fortune-pink to-fortune-light p-1 rounded-lg sticky top-24">
                <div className="bg-white p-6 rounded-lg h-full">
                  ...
                  >
                    ...
                    <span>Contact Us for Spain Jobs</span>
                  </a>
                  
                  <div className="mt-6 p-4 bg-gray-50 rounded-lg">
                    <h3 className="font-semibold text-gray-800 mb-2">Success Rate</h3>
                    <p className="text-gray-600 text-sm">
                      Fortune Technology has successfully placed over 200 candidates from Kolhapur in Spain in the last 3 years.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className="py-16 bg-gradient-to-r from-fortune-orange to-fortune-pink text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to Start Your Career in Spain?</h2>
          <p className="text-lg max-w-2xl mx-auto mb-8">
            Contact Fortune Technology today to discuss your qualifications and explore available opportunities in Spain.
          </p>
